        ...
        <div className="space-y-6">
          <div>
            <label htmlFor="apiKey" className="block text-sm font-semibold text-gray-700 mb-1 flex items-center">
              <KeyIcon className="w-4 h-4 mr-2" /> Gemini API Key
            </label>
            <input
              type="password"
              id="apiKey"
            ...
            />
             <p className="text-xs text-gray-500 mt-2 p-2 bg-gray-50 rounded-md">Your key is stored in your browser's local storage and is not sent anywhere except to the Gemini API.</p>
          </div>

          <div>
            <label htmlFor="model" className="block text-sm font-semibold text-gray-700 mb-1 flex items-center">
              <ServerIcon className="w-4 h-4 mr-2" /> Model
            </label>
            <select
              id="model"
              name="model"
            ...
            <p className="text-xs text-gray-500 mt-1">`gemini-2.5-flash` is recommended for its balance of speed and capability.</p>
          </div>
